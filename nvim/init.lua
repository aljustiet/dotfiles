...
vim.keymap.set('x', 'a', 'gj')
vim.keymap.set('x', 'e', 'gk')
...
vim.keymap.set('n', '<C-a>', '<C-w><C-a>', { desc = 'Move focus to the right window' })
...
vim.keymap.set('n', '<C-S-a>', '<C-w>A', { desc = 'Move window to the right' })
vim.keymap.set('n', '<C-S-e>', '<C-w>E', { desc = 'Move window to the lower' })
vim.keymap.set('n', '<C-S-i>', '<C-w>I', { desc = 'Move window to the upper' })
...
--   noremap = true,
--   silent = true,
--   desc = 'Copy to primary selection and clipboard',
-- })

-- Bonus: Replicating the paste command from your screenshot
-- The original was `map <C-v> "+P`
-- `map` applies to Normal, Visual, and Operator-pending modes.
